...
for raw in input_lines:
   _, result_game_to_parse = raw.split(':')

   green_cubes_found = get_cubes_by_color(result_game_to_parse, GREEN_CUBES_REGEX)
   min_required_green_cubes = max(green_cubes_found)

   red_cubes_found = get_cubes_by_color(result_game_to_parse, RED_CUBES_REGEX)
   min_required_red_cubes = max(red_cubes_found)

   blue_cubes_found = get_cubes_by_color(result_game_to_parse, BLUE_CUBES_REGEX)
   min_required_blue_cubes = max(blue_cubes_found)

   game_power = min_required_blue_cubes * min_required_green_cubes * min_required_red_cubes
   power += game_power
